// Exceeding requirements: Added NegativeGoal class for goals where points are subtracted when recorded (e.g., bad habits).
using System;
using System.IO;
        ...
        while (action != 6)
        {
            ...
            switch (action)
            {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    Console.WriteLine("\nThank you for using the goals Program!\n");
                    break;
                default:
                    Console.WriteLine($"\nSorry the option you entered is not valid.");
                    break;
